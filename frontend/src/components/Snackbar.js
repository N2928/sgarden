...
const SnackBar = () => {
	...
	return (
		<MaterialSnackbar
			...
			onClose={handleClose}
		>
			<Alert severity={severity} variant="filled" sx={{ alignItems: "center", color: "white!important" }} onClose={handleClose} data-testid={severity === "success" ? "profile-success-message" : severity === "error" ? "profile-error-message" : ""}>
